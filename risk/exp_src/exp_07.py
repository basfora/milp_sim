...
for per in list_img:
    ...
    for turn in specs.list_turns:
        ...
        # run simulator
        belief, target, team, solver_data, danger, mission = sr.run_simulator(specs, specs.danger_kill)
