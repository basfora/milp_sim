...
function create_layout(is_debug::Bool=false)
    ...
    # cafe
    r1 = Room(10, 17, RefineRectUR(), "room_1")

    is_debug && (r1.refine_method.nx = 3)
    is_debug && (r1.refine_method.ny = 5)

    # H3
    r2 = Room(10, 8.3, RefineTri(), "room_2")
    ...
    w8 = 17.0
    r8 = Room(w8, 31, RefineRectUR(), "room_8")
