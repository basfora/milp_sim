...
# -------------------------------------------
# organize vertices order
# -------------------------------------------
def reorder_ss2(V: list):
...
def adj_nodes(edges: list, s, e):
    """Create edges for adjacent nodes
    from vertex s to vertex e
